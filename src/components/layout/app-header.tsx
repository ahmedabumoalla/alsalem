  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border bg-card/95 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/sales/new" className="group flex min-w-0 flex-col"><span className="text-lg font-extrabold tracking-tight text-primary transition-colors group-hover:text-secondary sm:text-xl">FoamSales</span><span className="hidden text-xs text-muted sm:block">إدارة مبيعات الفلين</span></Link>
