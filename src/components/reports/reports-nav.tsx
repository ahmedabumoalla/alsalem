...
const links=[{href:"/reports",label:"نظرة عامة"},{href:"/reports#invoices",label:"الفواتير"},{href:"/reports/cost-center",label:"مركز التكلفة"},{href:"/reports/customer-balances",label:"ميزان العملاء"},{href:"/reports/receipts",label:"سندات القبض"}];
